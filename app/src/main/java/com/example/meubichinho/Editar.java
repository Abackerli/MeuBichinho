...
public class Editar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String btnDate = db.getAnimal(id).getDtNasc();
        String hintNome = db.getAnimal(id).getNome();
        String hintParentesco = db.getAnimal(id).getTitulo();
        String hintGenero = db.getAnimal(id).getGenero();

        nomeParente.setText(hintNome);
        parentesco.setText(hintParentesco);
        txtGenero.setHint(hintGenero);

        dtNasc = db.getAnimal(id).getDtNasc();

        gen = getGenero(db.getAnimal(id).getGenero());
    ...
    private void alterarDados(View v){
        Animal = new Animal(id, nome, titulo, "", gen, dtNasc);
    ...
    private void telameubichinho(){
        Intent intent = new Intent(Editar.this, meubichinho.class);
