...
public class Animal {
    ...
    public static final String ID_Animal = "id";
    ...
    public Animal(int id, String nome, String titulo, String imagem, String genero, String dtNasc) {
        this.id = id;
        this.nome = nome;
        this.titulo = titulo;
        this.imagem = imagem;
    ...
    public Animal(String nome, String titulo, String imagem, String genero, String dtNasc) {
        this.nome = nome;
        this.imagem = imagem;
        this.genero = genero;
        this.dtNasc = dtNasc;
        ...
        for (Parentesco parentesco:
            ...
            switch (parentesco.getIdTipoParentesco()){
                ...
                case TipoParentesco.pai:
                    setPai(parentesco);
                    break;
                case TipoParentesco.parceiro:
                    setParceiro(parentesco);
                    break;
            }
        }
    }
    ...
    public Parentesco getParceiro() {
        return parceiro;
    }

    public void setParceiro(Parentesco parceiro) {
