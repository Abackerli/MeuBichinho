package com.example.meubichinho.ui.view;
...
import com.example.meubichinho.db.FamilyDBHelper;
import com.example.meubichinho.interfaces.OnFamilyClickListener;
import com.example.meubichinho.model.FamilyBean;
...
public class NewFamilyTreeView extends ViewGroup {
    ...
    private static final int BACKGROUND_NORMAL = R.drawable.shape_bg_normal;
    private static final int BACKGROUND_SELEDTED = R.drawable.shape_bg_select;
    private static final int AVATAR_MALE = R.drawable.ic_avatar_male;
    private static final int AVATAR_FEMALE = R.drawable.ic_avatar_female;
